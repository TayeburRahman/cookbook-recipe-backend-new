...
const getRecipeDetails: RequestHandler = catchAsync(
  async (req: Request, res: Response) => {
    ...
    const result = await DashboardService.getRecipeDetails(id as any, authId as string);
    sendResponse(res, {
      statusCode: 200,
      success: true,
...
const addHelps = catchAsync(async (req: Request, res: Response) => {
  const result = await DashboardService.addHelps(req.body);
  sendResponse(res, {
    statusCode: 200,
    success: true,
    message: 'Successful',
...
const getHelps = catchAsync(async (req: Request, res: Response) => {
  const result = await DashboardService.getHelps();
  sendResponse(res, {
    statusCode: 200,
    success: true,
    message: 'Successful',
...
const getRecipesReviewsW = catchAsync(async (req: Request, res: Response) => {
  const recipeId = req.params.id as string;
  const query = req.query as any;
  // console.log('======', recipeId)
  const result = await DashboardService.getRecipesReviewsW(recipeId, query);
  sendResponse(res, {
    statusCode: 200,
    success: true,
    message: 'Reviews send successfully',
...
const sendSubscribe = async (req: Request, res: Response) => {

  const result = await DashboardService.sendSubscribe(req.body);
  sendResponse(res, {
    statusCode: 200,
    success: true,
...
const getSubscribe = async (req: Request, res: Response) => {
  const query = req.query;
  const result = await DashboardService.getSubscribe(query as any);
  sendResponse(res, {
    statusCode: 200,
    success: true,
    message: 'Subscribe get successfully',
    data: result,
  });
}
