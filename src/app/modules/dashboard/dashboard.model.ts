...
const aboutHelps = new mongoose.Schema(
    {
        description: {
            type: String,
            required: true,
...
const Helps = mongoose.model('Helps', aboutHelps);


const ContactSupport: Model<IContactSupport> = mongoose.model<IContactSupport>('ContactSupport', contactSupportSchema);

export { Subscription, Recipe, Comment, Review, Adds, Faq, TermsConditions, PrivacyPolicy, ContactSupport, AboutUs, Helps, Subscribe };
