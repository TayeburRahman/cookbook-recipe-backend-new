...
// website 
router.get('/get_recipe_detail/:id',
  auth(ENUM_USER_ROLE.USER, ENUM_USER_ROLE.ADMIN, ENUM_USER_ROLE.SUPER_ADMIN),
  DashboardController.getRecipeDetails,
);
router.get('/reviews/get/:id',
  auth(ENUM_USER_ROLE.USER),
  DashboardController.getRecipesReviewsW)
...
router.get('/get-help',
  DashboardController.getHelps,
);
router.post('/addupdate-help',
  DashboardController.addHelps,
);

router.get('/get-subscribe-mail',
  DashboardController.getSubscribe,
);
router.post('/send-subscribe-mail',
  DashboardController.sendSubscribe,
);
// ================================
